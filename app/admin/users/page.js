            ...
            {users.length === 0 ? (
              ...
              users.map((user,idx) => (
                <tr key={user.id} className="border-b">
                  ...
                  <td className="py-2 text-base">
                    {user.status === "ACTIVE" ? <Badge variant="default" className="text-green-700 bg-green-200 hover:bg-green-200 uppercase text-[10px]">Active</Badge> : <Badge variant="default" className="bg-gray-500 hover:bg-gray-500">Inactive</Badge> }
                    </td>
                </tr>
              ))
            )}
